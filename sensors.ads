...
is
   ...
   with 
     ...
     Pre => (Value_1 >= 0 and Value_2 >= 0 and Value_3 >= 0 and Value_1 <= Undef_Value and Value_2 <= Undef_Value and Value_3 <= Undef_Value);
   ...
   with
     ...
     Pre => (Sensor_Index >= Sensor_Index_Type'First and Sensor_Index < (Sensor_Index_Type'Last + 1));
